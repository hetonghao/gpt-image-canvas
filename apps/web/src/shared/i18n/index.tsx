...
const zhMessages = {
  ...
  summaryLlmGeminiHint: "推荐使用 Gemini 系列视觉模型，用于快速识别点击/框选区域并生成短描述。未配置时将复用 Agent LLM 配置。",
  ...
  hostApiKeysEmpty: "当前没有可用的 AI Cove API Key。请先在 AI Cove 创建 API Key，然后回到这里刷新。",
  ...
  hostSessionRequired: "请从已登录的 AI Cove 入口打开 AI Cove Design。如仍看到此提示，请重新登录 AI Cove。",
...
const enMessages: I18nMessages = {
  ...
  summaryLlmGeminiHint: "Recommended: Gemini vision models for quick clicked/marked-region descriptions. When this is empty, the Agent LLM config is reused.",
  ...
  hostSessionRequired: "Open AI Cove Design from a signed-in AI Cove entry. If this message persists, sign in to AI Cove again.",
