...
const zhMessages = {
  ...
  providerOnboardingCopy: "当前还没有可用的生图模型。请先填写 API Key、Base URL 和模型名称，保存后就可以在画布里生成图片。",
  providerOnboardingFieldFilled: "已填",
  providerOnboardingFieldMissing: "未填",
  providerOnboardingTitle: "先配置一个生图模型",
...
const enMessages: I18nMessages = {
  ...
  providerOnboardingCopy: "No image generation model is available yet. Add an API key, base URL, and model name, then save to start generating on the canvas.",
  providerOnboardingFieldFilled: "Filled",
  providerOnboardingFieldMissing: "Missing",
  providerOnboardingTitle: "Configure an image model first",
